...
echo "my job strart now" > DexSeq.log;
date >> DexSeq.log;

source /opt/common/tools/ric.cosr/miniconda3/bin/activate
conda activate jupyter_nb

for i in EDO_1 EDO_2 EDO_3 ND1_1 ND1_2 ND1_3 PW1_1 PW1_2 PW1_3
do
    ...
    /beegfs/scratch/ric.broccoli/ric.broccoli/PW_RNA_seq_deep/Bam_file/$i.bam \
