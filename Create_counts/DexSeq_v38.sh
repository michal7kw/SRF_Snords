...
python /home/kubacki.michal/.conda/envs/jupyter_nb/lib/R/library/DEXSeq/python_scripts/dexseq_count.py \
    ...
    /beegfs/scratch/ric.broccoli/kubacki.michal/SRF_Snords/DATA/v38/${sample}.bam \
    /beegfs/scratch/ric.broccoli/kubacki.michal/SRF_Snords/Create_counts/output_v38/${sample}_2.dexeq_counts

# Clean up output file
sed 's/\"//g' /beegfs/scratch/ric.broccoli/kubacki.michal/SRF_Snords/Create_counts/output_v38/${sample}_2.dexeq_counts | \
    grep -v "^_" > /beegfs/scratch/ric.broccoli/kubacki.michal/SRF_Snords/Create_counts/output_v38/${sample}_2.fixed.dexeq_counts
